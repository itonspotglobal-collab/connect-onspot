        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              <Button variant="ghost" size="sm" className="text-white/90 border border-white/20 bg-white/5 hover-elevate" asChild data-testid="social-facebook">
                <a href="https://facebook.com/onspot" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook">
                  <Facebook className="h-4 w-4" />
                </a>
              </Button>
              <Button variant="ghost" size="sm" className="text-white/90 border border-white/20 bg-white/5 hover-elevate" asChild data-testid="social-twitter">
                <a href="https://twitter.com/onspot" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Twitter">
                  <Twitter className="h-4 w-4" />
                </a>
              </Button>
              <Button variant="ghost" size="sm" className="text-white/90 border border-white/20 bg-white/5 hover-elevate" asChild data-testid="social-linkedin">
                <a href="https://linkedin.com/company/onspot" target="_blank" rel="noopener noreferrer" aria-label="Follow us on LinkedIn">
                  <Linkedin className="h-4 w-4" />
                </a>
              </Button>
              <Button variant="ghost" size="sm" className="text-white/90 border border-white/20 bg-white/5 hover-elevate" asChild data-testid="social-youtube">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            {/* Company */}
            <div className="space-y-3">
              <h3 className="font-semibold text-white text-base tracking-wide border-b border-white/20 pb-2">Company</h3>
              <ul className="space-y-2 text-white/85 text-sm">
            ...
            {/* Contact */}
            <div className="space-y-3">
              <h3 className="font-semibold text-white text-base tracking-wide border-b border-white/20 pb-2">Contact Us</h3>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end space-y-4 lg:space-y-0">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-start lg:justify-end space-x-2">
              ...
              <h3 className="text-lg font-semibold text-white">Download Our Platform</h3>
            </div>
