                          ...
                          {integration.icon ? (
                            typeof integration.icon === "string" ? (
                              ...
                              <img
                                ...
                                className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 object-contain opacity-80 group-hover:opacity-100 transition-all duration-300 grayscale group-hover:grayscale-0"
                              />
                            ) : (
