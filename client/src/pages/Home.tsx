...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Footer */}
      <footer className="relative bg-gradient-to-b from-violet-950/30 via-blue-950/30 to-zinc-950/50 backdrop-blur-md overflow-hidden">
        {/* Animated Luminescent Top Border - Enhanced */}
        <div className="absolute top-0 left-0 right-0 h-[2px] overflow-hidden">
          <div 
            className="h-full w-full bg-gradient-to-r from-transparent via-violet-400/70 through-blue-400/70 to-transparent"
            style={{ 
        ...
        {/* Subtle ambient glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-32 bg-violet-500/10 blur-[100px] pointer-events-none"></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 py-16 sm:py-20 lg:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="space-y-6 relative p-6 rounded-2xl bg-white/[0.02] backdrop-blur-sm border border-white/5">
                <img
                  src={onspotLogo}
                  alt="OnSpot"
            ...
            {/* Navigation Section */}
            <div className="space-y-6">
              <h3 className="text-base sm:text-lg font-semibold bg-gradient-to-r from-white via-violet-200 to-blue-200 bg-clip-text text-transparent tracking-wide">
                Navigation
              </h3>
              
              <div className="space-y-3">
                <Link href="/hire-talent" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-hire">
                  Hire Talent
                </Link>
                <Link href="/lead-intake" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-managed">
                  Managed Services
                </Link>
                <button
                  onClick={() => setShowVanessaChat(true)}
                  className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300 text-left"
                  data-testid="footer-link-ai"
                >
                  AI Assistant
                </button>
                <Link href="/waitlist" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-waitlist">
                  Join Waitlist
                </Link>
                <Link href="/careers" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-careers">
                  Careers
                </Link>
                <Link href="/powerapp" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-powerapp">
                  Powerapp
                </Link>
                <Link href="/pricing" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-pricing">
                  Pricing
                </Link>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <Link href="/why-onspot" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-why">
                  Why OnSpot
                </Link>
                <Link href="/stories" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-stories">
                  Amazing Stories
                </Link>
                <Link href="/insights" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-insights">
                  Insights
                </Link>
                <Link href="/affiliate" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-affiliate">
                  Affiliate Marketing
                </Link>
                <Link href="/bpo-partner" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-bpo">
                  BPO Partner
                </Link>
                <Link href="/investors" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-investors">
                  Investors Corner
                </Link>
                <Link href="/about" className="block text-sm text-white/65 hover:text-violet-300 hover:translate-x-1 transition-all duration-300" data-testid="footer-link-about">
                  About Us
                </Link>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-3">
                  <a href="#" className="flex items-center gap-3 px-4 py-2.5 rounded-lg bg-white/[0.04] backdrop-blur-sm border border-white/10 hover:bg-gradient-to-br hover:from-violet-500/25 hover:to-blue-500/25 hover:border-violet-400/60 hover:shadow-[0_0_15px_rgba(139,92,246,0.2)] transition-all duration-400 group" data-testid="download-ios">
                    ...
                    <span className="text-sm text-white/65 group-hover:text-violet-300 transition-colors">App Store</span>
                  </a>
                  <a href="#" className="flex items-center gap-3 px-4 py-2.5 rounded-lg bg-white/[0.04] backdrop-blur-sm border border-white/10 hover:bg-gradient-to-br hover:from-violet-500/25 hover:to-blue-500/25 hover:border-violet-400/60 hover:shadow-[0_0_15px_rgba(139,92,246,0.2)] transition-all duration-400 group" data-testid="download-android">
                    <svg className="w-5 h-5 text-white/50 group-hover:text-violet-300 group-hover:scale-110 transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.5,12.92 20.16,13.19L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
                    </svg>
                    <span className="text-sm text-white/65 group-hover:text-violet-300 transition-colors">Google Play</span>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <a href="mailto:hello@onspotglobal.com" className="flex items-center gap-3 text-sm text-white/65 hover:text-violet-300 transition-all duration-300 group" data-testid="footer-email">
                ...
                <a href="tel:+1234567890" className="flex items-center gap-3 text-sm text-white/65 hover:text-violet-300 transition-all duration-300 group" data-testid="footer-phone">
          ...
          <div className="mt-16 pt-8 border-t border-white/[0.08]">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-white/45">
              <p className="hover:text-white/60 transition-colors duration-300">© 2025 OnSpot Global. All rights reserved.</p>
