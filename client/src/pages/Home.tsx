import { ArrowRight, CircleDollarSign, UserCheck, Zap } from "lucide-react";
  ...
  return (
    <div>
      <HeadSEO
        ...
        description="Hire vetted Philippine talent faster with OnSpot."
      />

      {/* ── 1. HERO ── */}
      <section className="relative overflow-hidden flex flex-col hero-investor">
