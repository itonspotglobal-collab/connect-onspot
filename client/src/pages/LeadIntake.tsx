...
const leadIntakeSchema = z.object({
  ...
  decisionMakerStatus: z
    .string()
    .min(1, "Please select your role in decision making"),
        ...
        <div className="mb-8">
          <div className="text-center mb-6">
            ...
            <p className="text-muted-foreground">
              Tell us about your needs and we'll create a custom solution for
              you
            </p>
          </div>
          ...
          <div className="flex justify-center space-x-4 mb-8">
            {STEPS.map((step) => {
              ...
              return (
                <div
                  key={step.id}
                  className={`flex flex-col items-center space-y-2 ${isActive ? "text-primary" : isCompleted ? "text-green-600" : "text-muted-foreground"}`}
                >
                  <div
            ...
            <CardContent className="space-y-6">
              ...
              {currentStep === 1 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label htmlFor="jobTitle" data-testid="label-job-title">
                        Job Title *
                      </Label>
                      <Input
                        id="jobTitle"
              ...
              {currentStep === 2 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label data-testid="label-company-size">
                        Company Size *
                      </Label>
                      <Select
                        onValueChange={(value) =>
                  ...
                  <div>
                    <Label htmlFor="companyWebsite" data-testid="label-website">
                      Company Website
                    </Label>
                    <Input
                      id="companyWebsite"
              ...
              {currentStep === 3 && (
                <div className="space-y-4">
                  <div>
                    <Label data-testid="label-service-type">
                  ...
                  <div>
                    <Label
                      htmlFor="serviceVolume"
                      data-testid="label-service-volume"
                    >
              ...
              {currentStep === 4 && (
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label data-testid="label-urgency">
                        How urgently do you need this? *
                      </Label>
                      <Select
                        onValueChange={(value) =>
                          form.setValue("urgencyLevel", value)
                        }
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="within_quarter">
                            Within 3 months
                          </SelectItem>
                      ...
                      {form.formState.errors.urgencyLevel && (
                        <p className="text-sm text-red-600 mt-1">
                          {form.formState.errors.urgencyLevel.message}
                        </p>
                      )}
                    </div>

                    <div>
                      <Label data-testid="label-budget">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="teamSize" data-testid="label-team-size">
                    ...
                    <div>
                      <Label data-testid="label-decision-maker">
                        Your role in decision making *
                      </Label>
                      <Select
                        onValueChange={(value) =>
                          form.setValue("decisionMakerStatus", value)
                        }
                      >
                      ...
                      {form.formState.errors.decisionMakerStatus && (
                        <p className="text-sm text-red-600 mt-1">
                          {form.formState.errors.decisionMakerStatus.message}
                        </p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        form.setValue("hasCurrentProvider", !!checked)
                      }
                    />
                  ...
                  {form.watch("hasCurrentProvider") && (
                    <div>
                      <Label
                        htmlFor="currentProviderDetails"
                        data-testid="label-provider-details"
                      >
                  ...
                  <div>
                    <Label
                      ...
                      data-testid="label-additional-notes"
                    >
                      Additional Notes
                    </Label>
                    <Textarea
                ...
                <div className="text-center space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mb-4">
                      We've received your information! Ready to take the next
                      step?
                    </p>
                    <div className="bg-muted/50 p-4 rounded-lg mb-6">
                      <p className="text-sm text-muted-foreground">
                        ...
                        <br />
                        Schedule your free consultation call with our BPO
                        experts. We'll review your requirements and prepare a
                  ...
                  <div className="space-y-4">
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          "https://calendly.com/hello-onspotglobal/lead-intake-schedule",
                        )
                      }
