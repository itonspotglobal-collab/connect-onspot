...
const serviceModels = [
  {
    title: "Resourced",
    subtitle: "You Manage",
    description: "Flat FTE rate with best-in-class hires and dedicated account manager",
    range: "1-20 FTE",
    target: "Founders who want cost savings and direct control",
    outcome: "Lower costs, more control—but you handle performance",
    features: ["Pre-screened professionals", "Dedicated account manager", "Standard support", "Direct management control"],
    icon: Users,
  ...
  },
  {
    ...
    description: "Full-service management with dedicated team manager and process optimization",
    range: "5-50 FTE",
    target: "Growth-focused leaders who want KPIs delivered without micro-managing",
    outcome: "Hands-off growth: predictable KPIs, faster scale, less stress",
    features: ["Everything in Resourced", "Dedicated team manager", "24/7 support", "Process building", "KPI accountability"],
    icon: Target,
  ...
  },
  {
    ...
    description: "Enterprise-grade scalability with full customization and dedicated teams",
    range: ">50 FTE",
    ...
    features: ["Everything in Managed", "1,000+ FTE capacity", "Enterprise processes", "Custom integrations", "Dedicated campaign team"],
    icon: Building2,
...
const marketOpportunity = {
  ...
  tamDefinition: "Total Addressable Market: The entire U.S. BPO market by 2030, representing the full revenue opportunity if OnSpot captured 100% market share across all segments and customer types.",
  sam: "$30-40B", // SME + mid-market (30-40% of U.S. BPO spend)
  samDefinition: "Serviceable Addressable Market: The SME and mid-market segment (30-40% of total U.S. BPO spend), representing businesses with 10-500 employees that align with OnSpot's service model and pricing structure.",
  som: "$400M-1.2B", // 1-2% of SAM in 3-5 years
  somDefinition: "Serviceable Obtainable Market: Realistic market capture of 1-2% of SAM within 3-5 years, based on our current growth trajectory, competitive positioning, and operational capacity for scaling.",
...
const leadershipTeam = [
  {
    ...
    quote: "We turned our operational struggles into the creation of OnSpot, helping businesses like ours in New York grow and succeed with easy and efficient outsourcing solutions.",
    experience: "Founded 15 companies in multiple sectors across US and Philippines"
  },
  {
    name: "Jake Wainberg",
    role: "Founder & President",
    quote: "We understand your struggle with operational costs because we've been there. To grow our New York businesses, we created OnSpot, and its success led our friends to join us.",
    experience: "Handled 1,000+ brands and accounts with 10,000+ employees in BPO industry"
  }
];
...
export default function InvestorsCorner() {
  ...
  useEffect(() => {
    // Set page title
    document.title = "Investors Corner - OnSpot Global | Investment Opportunity";
    ...
    updateMetaName('description', 'Investment opportunity in OnSpot Global - The evolution of outsourcing. Built by entrepreneurs for entrepreneurs. 80+ clients served, $50M+ value delivered, battle-tested growth with 500+ resources deployed.');
    
    // Update Open Graph tags
    updateMetaTag('og:title', 'Investors Corner - OnSpot Global | Investment Opportunity');
    updateMetaTag('og:description', 'Join the outsourcing revolution. OnSpot bridges BPO and freelancing with proven traction: 80+ clients, $50M+ delivered, 70% cost savings. From battle scars to global scale.');
    ...
    updateMetaName('twitter:description', 'Investment opportunity in the evolution of outsourcing. 80+ clients, $50M+ value delivered, battle-tested platform ready to scale globally.');
  ...
  return (
    <div className="space-y-0 overflow-hidden">
      ...
      <div className="bg-muted/30 py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center space-y-6 mb-16">
              <h2 className="text-4xl md:text-5xl font-bold">The 60-Second Story</h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                From BPO battleground to global outsourcing empire - built from battle scars
              </p>
            </div>
            
            {/* The Exact 60-Second Narrative */}
            <div className="bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 rounded-xl p-8 mb-16" data-testid="text-60s-story">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mt-6">
                  <div className="font-semibold text-primary">Nur Laminero & Jake Wainberg</div>
                  <div className="text-sm text-muted-foreground">Co-Founders, OnSpot Global</div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              {leadershipTeam.map((leader, index) => (
                <Card key={index} className="hover-elevate transition-all duration-300" data-testid={`leader-${leader.name.toLowerCase().replace(/\s+/g, "-")}`}>
                  <CardHeader>
            ...
            <div className="text-center">
              <div className="inline-flex items-center gap-2 text-lg font-semibold text-primary">
                ...
                Joint force: 15 companies founded, 1,000+ brands handled, 10,000+ employees managed
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="py-24" data-testid="section-problem">
        <div className="container mx-auto px-6">
          <div className="text-center space-y-6 mb-16">
            <h2 className="text-4xl md:text-5xl font-bold">The Problem: Outsourcing is Broken</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Current outsourcing landscape creates a broken bridge between businesses and solutions.
            </p>
            
            {/* Broken Bridge Visual Concept */}
            <div className="flex items-center justify-center space-x-4 my-8" data-testid="broken-bridge-visual">
              <div className="text-center">
                <div className="w-16 h-16 bg-red-500/10 rounded-full flex items-center justify-center mb-2">
                  <Users className="w-8 h-8 text-red-500" />
                </div>
                <div className="text-sm font-medium">Freelancing</div>
                <div className="text-xs text-muted-foreground">Chaotic, Unreliable</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-muted-foreground">Expensive, Rigid</div>
              </div>
            </div>
            
            {/* Bridging the Gap Solution */}
            <div className="bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 rounded-xl p-6 mt-8" data-testid="section-solution">
              <div className="flex items-center justify-center space-x-4" data-testid="bridging-gap-visual">
                <div className="text-center">
              ...
              <div className="text-center mt-4">
                <div className="text-primary font-bold">OnSpot: The Unified Outsourcing Platform</div>
                <div className="text-sm text-muted-foreground">Flexibility of freelancing + Reliability of BPO</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-12">
            {problemSolutions.map((item, index) => (
              <Card key={index} className="hover-elevate transition-all duration-300" data-testid={`problem-solution-${index}`}>
                <CardContent className="p-8">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                    <div className="text-center lg:text-left space-y-3">
                      <div className={`w-12 h-12 ${item.color} bg-current/10 rounded-full flex items-center justify-center mx-auto lg:mx-0`}>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {tractionStats.map((stat, index) => (
              <Card key={index} className="hover-elevate transition-all duration-300 bg-white dark:bg-card" data-testid={stat.label === "Resources Deployed" ? "card-stat-resources" : `traction-${index}`}>
                <CardContent className="p-6">
                  ...
                  <div>
                    <div className="font-medium text-base mb-1">{stat.label}</div>
          ...
          <div className="bg-gradient-to-r from-primary/5 to-green-500/5 rounded-xl p-8 mb-8" data-testid="timeline-visual">
            ...
            <div className="flex items-center justify-between max-w-4xl mx-auto">
              ...
              <div className="text-center space-y-2">
                ...
                <div className="text-xs text-muted-foreground">Scale to empire</div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <Badge variant="outline" className="text-base px-6 py-2">
              15 Startups Founded by Leadership Team • $39B Annual Outsourcing Revenue in Philippines
            </Badge>
          </div>
        </div>
      </div>
      ...
      <div className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center space-y-6 mb-16">
            <h2 className="text-4xl md:text-5xl font-bold">Market Opportunity</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              The global outsourcing market is experiencing unprecedented growth, with OnSpot perfectly positioned to capture significant market share.
            </p>
          </div>

          {/* U.S. BPO Market Key Facts */}
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-xl p-8 mb-16" data-testid="us-bpo-market-data">
            <h3 className="text-2xl font-bold text-center mb-6">U.S. BPO Market - Key Data Points</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div className="space-y-2">
                <div className="text-3xl font-bold text-blue-600">{marketOpportunity.usMarket2022}</div>
                <div className="text-sm text-muted-foreground">U.S. BPO Market Size (2022)</div>
              </div>
              <div className="space-y-2">
                <div className="text-3xl font-bold text-green-600">{marketOpportunity.cagr}</div>
                <div className="text-sm text-muted-foreground">CAGR (2023-2030)</div>
              </div>
              <div className="space-y-2">
                <div className="text-3xl font-bold text-purple-600">{marketOpportunity.projected2030}</div>
                <div className="text-sm text-muted-foreground">Projected by 2030</div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-center mb-8">Market Layers - Detailed Breakdown</h3>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6" data-testid="tam-sam-som-table">
              <Card className="hover-elevate">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    <Target className="w-8 h-8 text-green-600" />
                    <div>
                      <CardTitle className="text-xl" data-testid="text-tam">TAM - {marketOpportunity.tam}</CardTitle>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Entire U.S. BPO market + all businesses that could use hybrid outsourcing (freelancers + structured BPO). 
                      Includes large enterprises + SMEs spending on BPO, managed services, process outsourcing.
                    </p>
                    <p className="text-sm font-medium text-green-600">
                      USD ~140B by 2030 - the ceiling if OnSpot could cover almost all standard BPO spend.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="hover-elevate">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <CardTitle className="text-xl" data-testid="text-sam">SAM - {marketOpportunity.sam}</CardTitle>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <p className="text-sm font-medium">Definition:</p>
                    <p className="text-sm text-muted-foreground">
                      SME + Mid-market businesses in the U.S. that want flexible, accountable outsourcing using hybrid models. 
                      Limited to service types OnSpot is building (customer service, finance & accounting, HR, technical support).
                    </p>
                    <p className="text-sm font-medium text-purple-600">
                      30-40% of U.S. BPO spend in our target segments and business sizes.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="hover-elevate">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <CardTitle className="text-xl" data-testid="text-som">SOM - {marketOpportunity.som}</CardTitle>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <p className="text-sm font-medium">Definition:</p>
                    <p className="text-sm text-muted-foreground">
                      What OnSpot can realistically capture in U.S. in near term (3-5 years) given resources, competition, 
                      adoption curves, CAC/LTV constraints.
                    </p>
                    <p className="text-sm font-medium text-orange-600">
                      1-2% of SAM in 3-5 years. Aggressive execution could reach 3-4% → $1.2-2.4B.
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <Card className="hover-elevate text-center">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">{marketOpportunity.globalMarket}</CardTitle>
            ...
            <Card className="hover-elevate text-center">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">{marketOpportunity.tam}</CardTitle>
                <CardDescription>Total Addressable Market</CardDescription>
              </CardHeader>
            </Card>
            <Card className="hover-elevate text-center">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">{marketOpportunity.sam}</CardTitle>
                <CardDescription>Serviceable Addressable Market</CardDescription>
              </CardHeader>
            </Card>
            <Card className="hover-elevate text-center">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">{marketOpportunity.growth}</CardTitle>
          ...
          <Card className="hover-elevate">
            <CardHeader>
              <CardTitle className="text-center text-2xl">Market Segments</CardTitle>
      ...
      <div className="bg-muted/30 py-24">
        <div className="container mx-auto px-6">
          <div className="text-center space-y-6 mb-16">
            <h2 className="text-4xl md:text-5xl font-bold">Why the Philippines</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Strategic advantages that give OnSpot unmatched competitive positioning in the global talent market.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {philippinesAdvantages.map((advantage, index) => (
              <Card key={index} className="hover-elevate transition-all duration-300" data-testid={`advantage-${index}`}>
      ...
      <div className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center space-y-6 mb-16">
            <h2 className="text-4xl md:text-5xl font-bold">Proven Business Model</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Three scalable service models designed for different growth stages, from startup to enterprise scale.
            </p>
          </div>

          <div className="space-y-8">
            {serviceModels.map((model, index) => (
              <Card key={index} className="hover-elevate transition-all duration-300 overflow-hidden" data-testid={`service-model-${model.title.toLowerCase()}`}>
                <div className="relative">
                  {model.badge && (
                    <div className="absolute top-6 right-6 z-10">
                      <Badge className="bg-green-500 text-white">{model.badge}</Badge>
                    </div>
                  )}
                    ...
                    <div className="lg:col-span-2 p-8 space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-primary font-medium">{model.outcome}</p>
                        </div>

                        <div>
                          <h4 className="font-semibold mb-2">Pricing:</h4>
                          <p className="text-sm text-muted-foreground">{model.priceNote}</p>
                        </div>
                      </div>
                    </div>
      ...
      <div className="bg-primary/5 dark:bg-primary/10 py-24">
        <div className="container mx-auto px-6">
          <div className="text-center space-y-6 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From 50k vetted talent to global expansion—our roadmap for becoming the world's leading outsourcing platform.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="hover-elevate text-center">
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="text-sm text-muted-foreground">50k+ Vetted Talent</div>
                  <div className="text-sm text-muted-foreground">85 Active Clients</div>
                  <div className="text-sm text-muted-foreground">Multiple Industries</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="hover-elevate text-center">
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="text-sm text-muted-foreground">Multi-Country Presence</div>
                  <div className="text-sm text-muted-foreground">Regional Partnerships</div>
                  <div className="text-sm text-muted-foreground">Local Compliance</div>
                </div>
              </CardContent>
            </Card>
      ...
      <div className="py-24 bg-muted/30" data-testid="section-traction-timeline">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center space-y-6 mb-16">
              ...
              <div className="space-y-12">
                <div className="flex items-center space-x-8">
                  <div className="flex-1 text-right">
                    <Card className="inline-block p-6 max-w-md">
                      <h3 className="text-lg font-bold mb-2">2021: Foundation</h3>
                      <p className="text-sm text-muted-foreground">Born from operational struggles in New York. First clients onboarded.</p>
                    </Card>
                  </div>
                ...
                <div className="flex items-center space-x-8">
                  ...
                  <div className="flex-1">
                    <Card className="inline-block p-6 max-w-md">
                      <h3 className="text-lg font-bold mb-2">2022: Rapid Growth</h3>
                      <p className="text-sm text-muted-foreground">Scaled to 50+ clients, 200+ resources deployed. Proven cost savings model.</p>
                    </Card>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-8">
                  <div className="flex-1 text-right">
                    <Card className="inline-block p-6 max-w-md">
                      <h3 className="text-lg font-bold mb-2">2023: Market Validation</h3>
                      <p className="text-sm text-muted-foreground">80+ clients served, $50M+ value delivered. Enterprise clients acquired.</p>
                    </Card>
                  </div>
                  <div className="w-4 h-4 bg-primary rounded-full relative z-10"></div>
                  <div className="flex-1"></div>
                ...
                <div className="flex items-center space-x-8">
                  ...
                  <div className="flex-1">
                    <Card className="inline-block p-6 max-w-md">
                      <h3 className="text-lg font-bold mb-2">2024: Platform Innovation</h3>
                      <p className="text-sm text-muted-foreground">OnSpotConnect launched. Unifying BPO and freelancing for future growth.</p>
                    </Card>
                  </div>
                </div>
              </div>
      ...
      <div className="py-24" data-testid="section-competitive-advantage">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center space-y-6 mb-16">
              <h2 className="text-4xl md:text-5xl font-bold">Competitive Advantage</h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              ...
              <table className="w-full border border-border rounded-lg overflow-hidden">
                <thead className="bg-primary/5">
                  <tr>
                    ...
                    <th className="p-4 text-center font-semibold">Traditional BPO</th>
                    <th className="p-4 text-center font-semibold">Freelancing</th>
                    <th className="p-4 text-center font-semibold text-primary">OnSpot</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-t border-border">
                    <td className="p-4 font-medium">Cost Savings</td>
                    <td className="p-4 text-center text-muted-foreground">30-50%</td>
                    <td className="p-4 text-center text-muted-foreground">Variable</td>
                    <td className="p-4 text-center font-semibold text-green-600">Up to 70%</td>
                  </tr>
                  <tr className="border-t border-border bg-muted/20">
                    <td className="p-4 font-medium">Setup Time</td>
                    <td className="p-4 text-center text-muted-foreground">3-6 months</td>
                    <td className="p-4 text-center text-muted-foreground">Days to weeks</td>
                    <td className="p-4 text-center font-semibold text-green-600">21 days</td>
                  </tr>
                  <tr className="border-t border-border">
                    <td className="p-4 font-medium">Quality Control</td>
                    <td className="p-4 text-center text-muted-foreground">Rigid processes</td>
                    <td className="p-4 text-center text-destructive">Inconsistent</td>
                    <td className="p-4 text-center font-semibold text-green-600">Managed excellence</td>
                  </tr>
                  <tr className="border-t border-border bg-muted/20">
                    ...
                    <td className="p-4 text-center font-semibold text-green-600">1-1000+ FTE</td>
                  </tr>
                  <tr className="border-t border-border">
                    <td className="p-4 font-medium">Management</td>
                    <td className="p-4 text-center text-muted-foreground">Client dependent</td>
                    <td className="p-4 text-center text-destructive">Fully client managed</td>
                    <td className="p-4 text-center font-semibold text-green-600">Fully managed option</td>
                  </tr>
                  <tr className="border-t border-border bg-muted/20">
                    <td className="p-4 font-medium">Technology</td>
                    <td className="p-4 text-center text-muted-foreground">Legacy systems</td>
                    <td className="p-4 text-center text-muted-foreground">No integration</td>
                    <td className="p-4 text-center font-semibold text-green-600">OnSpotConnect platform</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <div className="py-24 bg-muted/30" data-testid="section-scale-strategy">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center space-y-6 mb-16">
              <h2 className="text-4xl md:text-5xl font-bold">Scale Strategy: From Scars to Empire</h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Our proven roadmap for dominating the global outsourcing market
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-testid="scale-strategy-grid">
      ...
      <div className="py-24" data-testid="section-financials">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center space-y-6 mb-16">
              <h2 className="text-4xl md:text-5xl font-bold">Financial Projections</h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Path to profitability and sustainable growth
              </p>
            </div>
            
            <Card className="bg-gradient-to-r from-primary/5 to-green-500/5 border-primary/20" data-testid="financials-preview">
              <CardContent className="p-12 text-center space-y-6">
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto">
                  <BarChart3 className="w-8 h-8 text-primary" />
                </div>
                <h3 className="text-2xl font-bold">Detailed Financial Models Available</h3>
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  Comprehensive 5-year financial projections, unit economics, and ROI analysis available for qualified investors.
                  Contact us to access detailed financial models and investment terms.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Button size="lg" asChild data-testid="button-request-financials">
                    <Link href="/lead-intake">
                      <BarChart3 className="w-5 h-5 mr-2" />
                      Request Financial Package
                    </Link>
                  </Button>
                  <Button variant="outline" size="lg" asChild data-testid="link-investor-deck">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="space-y-6">
              <blockquote className="text-xl md:text-2xl font-medium text-center leading-relaxed italic border-l-4 border-primary pl-6">
                ...
                OnSpot isn't just another outsourcing company. We've proven we can fight, bleed, and win. 
                Now we're building the platform to dominate the global stage. With your backing, we'll turn scars into scale — and scale into empire.
                <span className="text-3xl text-primary">"</span>
              </blockquote>
            ...
            <div className="bg-gradient-to-r from-primary/5 to-green-500/5 rounded-xl p-8 mt-12" data-testid="global-expansion-map">
              <h3 className="text-xl font-bold text-center mb-6">Global Expansion Vision</h3>
            ...
            <div className="pt-8">
              <Card className="bg-gradient-to-r from-primary/5 to-primary/10 border-primary/20">
                <CardContent className="p-8 space-y-6">
                  <h3 className="text-2xl font-bold">Ready to Fuel the Vision?</h3>
                  <p className="text-muted-foreground max-w-2xl mx-auto">
                    Join us in revolutionizing how the world thinks about outsourcing. 
                    Partner with battle-tested entrepreneurs who turn challenges into competitive advantages.
                  </p>
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Button size="lg" asChild data-testid="button-investor-meeting">
                      <Link href="/lead-intake">
                        <Calendar className="w-5 h-5 mr-2" />
                        Schedule Investment Meeting
                      </Link>
                    </Button>
                    <Button variant="outline" size="lg" asChild data-testid="link-investor-email">
                  ...
                  <div className="flex items-center justify-center space-x-6 text-sm text-muted-foreground">
                    <Button variant="ghost" size="sm" asChild data-testid="link-investor-phone">
                      <a href="tel:+17185405053" className="flex items-center space-x-2 hover-elevate">
