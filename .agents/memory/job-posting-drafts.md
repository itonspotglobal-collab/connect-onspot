...
**How to apply:** Keep Client ownership derived from authentication, reject empty new drafts, allow partial draft fields through draft-specific normalization without weakening final form validation, exclude drafts explicitly from public/internal discovery queries, and hide approval/open/refresh actions until submission.